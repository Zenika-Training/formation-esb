...
@WebServiceClient(name = "hotelService", 
                  wsdlLocation = "file:/C:/workspace_esb/tp8/src/main/resources/wsdl/hotel.wsdl",
...
public class HotelService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/workspace_esb/tp8/src/main/resources/wsdl/hotel.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/C:/workspace_esb/tp8/src/main/resources/wsdl/hotel.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
